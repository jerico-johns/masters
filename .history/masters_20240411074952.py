...
# Inside the main column, create a two-column layout
with col1:
    # Add a dropdown menu for filtering by 'Name' in the first column
    with st.expander("Filter Options"):
        name_filter = st.selectbox('Filter by Name', merged_df['Name'].unique())

    # Filter the dataframe based on the selected name
    filtered_df = merged_df[merged_df['Name'] == name_filter]
