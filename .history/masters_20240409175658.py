...
def main():
    ...
    st.dataframe(data = merged_df, hide_index=True, column_order = ['Name', 'Score', 'Tiebreaker', '1.1', '1.1 Score', '1.2', '1.3', '2.1', '2.2', '2.3', '3.1', '3.2', '4.1', '1.2 Score', '1.3 Score', '2.1 Score', '2.2 Score', '2.3 Score', '3.1 Score', '3.2 Score', '4.1 Score', 'Score', 'Tiebreaker'])
