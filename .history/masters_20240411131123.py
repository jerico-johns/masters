...
def calculate_top_n(row, n):
    scores = [row['tier_1_1_score'], row['tier_1_2_score'], row['tier_1_3_score'], row['tier_2_1_score'], row['tier_2_2_score'], row['tier_2_3_score'], ow['tier_3_2_score']row['tier_3_2_score'], row['tier_4_1_score']]
