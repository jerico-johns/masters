...
def main():
    ...
    merged_df = merged_df.rename(columns = {'name': 'Name', 'tier_1_1': '1.1', 'tier_1_2': '1.2', 'tier_1_3': '1.3', 'tier_2_1': '2.1', 'tier_2_2': '2.2'})
    st.dataframe(data = merged_df, hide_index=True)
