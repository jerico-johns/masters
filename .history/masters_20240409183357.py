...
def main():
    ...
    merged_df = merged_df.rename(columns = {'name': 'Name', 'tier_1_1': '1', 'tier_1_2': '1.2', 'tier_1_3': '1.3', 'tier_2_1': '2.1', 'tier_2_2': '2.2', 'tier_2_3': '2.3', 'tier_3_1': '3.1', 'tier_3_2': '3.2', 'tier_4_1': '4.1', 
